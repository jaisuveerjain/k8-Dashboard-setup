#!/bin/bash
if [[ "$1" == 'install' ]]; then 
    kubectl apply -f kubectl apply -f https://raw.githubusercontent.com/jaisuveerjain/k8-Dashboard-setup/refs/heads/main/Kubernetes_Dashboard.yaml
...
EOF
    ...
    kubectl delete -f kubectl apply -f https://raw.githubusercontent.com/jaisuveerjain/k8-Dashboard-setup/refs/heads/main/Kubernetes_Dashboard.yaml
